...
un SEUL fichier (`qmc_quantum_framework_v2_7_3.py`) ; ce shim n'est qu'une ré-export
...
(ex. `_v2_7_2` -> `_v2_7_3`), sans casser les scripts utilisateurs.
    ...
    from qmc import QMCFramework            # au lieu de qmc_quantum_framework_v2_7_3
    fw = QMCFramework(...)

NB : l'import du framework est PUR et rapide (~0.1 s ; qiskit_ibm_runtime est chargé
paresseusement au premier usage QPU).
"""
from qmc_quantum_framework_v2_7_3 import *          # noqa: F401,F403  (API publique via __all__)
from qmc_quantum_framework_v2_7_3 import __all__, __version__  # noqa: F401
